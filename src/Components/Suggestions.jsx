...
export default function Suggestions({ setChat }) {
    return (
        <div className='grid grid-cols-2 grid-rows-2 gap-[14px] w-full'>
            <div onClick={() => setChat('Get me the appropriate cure for common cold')} className="hover:bg-green-600 group hover:text-white hover:ease-in-out duration-300 cursor-pointer py-4 px-[10px] rounded-lg border-[0.5px] border-[#909090] flex gap-2 items-center">
            ...
            <div onClick={() => setChat('Get me the appropriate cure for Influenza (Flu)')} className="hover:bg-green-600 group hover:text-white hover:ease-in-out duration-300 cursor-pointer py-4 px-[10px] rounded-lg border-[0.5px] border-[#909090] flex gap-2 items-center">
                <div className='w-[50px] h-[50px]'>
            ...
            <div onClick={() => setChat('Get me the appropriate cure for Gastroenteritis')} className="hover:bg-green-600 group hover:text-white hover:ease-in-out duration-300 cursor-pointer py-4 px-[10px] rounded-lg border-[0.5px] border-[#909090] flex gap-2 items-center">
                <div className='w-[50px] h-[50px]'>
            ...
            <div onClick={() => setChat('Get me the appropriate cure for Headaches/Migraines')} className="hover:bg-green-600 group hover:text-white hover:ease-in-out duration-300 cursor-pointer py-4 px-[10px] rounded-lg border-[0.5px] border-[#909090] flex gap-2 items-center">
                <div className='w-[50px] h-[50px]'>
